...
export const ORCHESTRATION_BUNDLE_SCHEMA_VERSION = 4;
export const ORCHESTRATION_COMPOSER_VERSION = "1.2.0";
...
function normalizeReleaseIdentity(identity = {}, schemaVersion = ORCHESTRATION_BUNDLE_SCHEMA_VERSION) {
  ...
  const expectedComposerVersion = schemaVersion === 2 ? "1.0.0" : schemaVersion === 3 ? "1.1.0" : ORCHESTRATION_COMPOSER_VERSION;
...
export function validateOrchestrationBundle(bundle) {
  ...
  if (!isPlainObject(bundle) || ![2, 3, ORCHESTRATION_BUNDLE_SCHEMA_VERSION].includes(bundle.schema_version) || bundle.bundle_type !== "jit_orchestration") {
